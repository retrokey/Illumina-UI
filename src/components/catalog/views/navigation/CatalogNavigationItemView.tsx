...
export const CatalogNavigationItemView: FC<CatalogNavigationItemViewProps> = ({ node = null, child = false }) => {
    ...
    const getItemClasses = () => {
        return `
            ...
            ${node.isActive && child ? "bg-[url('/client-assets/images/catalogue/child-item-bg.png')] dark:bg-[url('/client-assets/images/catalogue/child-item-dark-bg.png')]" : ""}
            ${child ? "hover:bg-[url('/client-assets/images/catalogue/child-item-bg.png')] dark:hover:bg-[url('/client-assets/images/catalogue/child-item-dark-bg.png')]" : ""}
        `
    }
    ...
    return (
        <>
            <div className={getItemClasses()} onClick={(event) => activateNode(node)}>
                ...
                {node.isBranch && (
                    <>
                        {node.isOpen && <i className="h-[5px] w-[9px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-277px_-32px]" />}
                        {!node.isOpen && <i className="h-[9px] w-[5px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-270px_-32px]" />}
                    </>
                )}
            </div>
