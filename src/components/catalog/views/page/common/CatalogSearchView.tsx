    ...
    return (
        <div className="illumina-input relative h-[26px] w-full">
            ...
            {searchValue?.length > 1
                ? <i className="absolute right-1.5 top-1.5 size-[11px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-63px_-207px] bg-no-repeat" onClick={ event => setSearchValue("") } />
