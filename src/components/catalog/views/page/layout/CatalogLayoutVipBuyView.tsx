    ...
    const PurchaseDialog = () => (
        <LayoutNotificationAlertView onClose={() => setPurchaseState(CatalogPurchaseState.NONE)} title={ LocalizeText("catalog.purchase_confirmation.title") } style={{ width: 369 }}>
            <div className="mb-[17px] flex gap-[9px]">
                <div className="mb-1">
                    <i className="catalog-club-preview block h-10 w-[68px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-209px_-212px]" />
                </div>
                ...
                <div className="flex flex-1 flex-col justify-between">
                    <div className="flex flex-col gap-1">
                        { clubOffers && (clubOffers.length > 0) && clubOffers.map((offer, index) => (
                            <div key={ index } className="h-[75px] w-80 bg-[url('/client-assets/images/catalogue/hc-item-bg.png')] p-[5px] pb-2 dark:bg-[url('/client-assets/images/catalogue/hc-item-dark-bg.png')]">
                                <div className="flex h-[25px] w-[310px] items-center px-[7px] py-1">
                                    <i className="block h-[17px] w-[31px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-273px_-84px]" />
