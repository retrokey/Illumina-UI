...
export const CatalogPurchaseWidgetView: FC<CatalogPurchaseWidgetViewProps> = props =>
{
    ...
    return (
        <div className="flex gap-2.5">
            ...
            {isLimitedSoldOut
                ? <div className="relative h-[30px] w-[360px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-102px_-181px]">
