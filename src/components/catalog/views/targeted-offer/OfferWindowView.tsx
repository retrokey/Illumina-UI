        ...
        <NitroCardContentView gap={ 1 }>
            ...
            <div className="flex justify-between">
                <div className="illumina-offers-content relative mb-[30px] h-[249px] w-80 px-[13px] py-[18px]">
                    ...
                    <div className="absolute bottom-[-27px] -right-10 flex h-[138px] w-[136px] flex-col items-center justify-center gap-2.5 bg-[url('/client-assets/images/offers/price-bg.png')]">
