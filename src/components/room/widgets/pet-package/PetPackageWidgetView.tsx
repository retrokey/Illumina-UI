                        ...
                        <div className="flex w-full flex-col px-3">
                            <div className="flex flex-col">
                                <div className="illumina-input relative mt-[15px] h-[34px] w-full">
                                    ...
                                    <i className="absolute right-[3px] top-[9px] h-[18px] w-[17px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-335px_0px] bg-no-repeat" />
                                </div>
