            ...
            <NitroCardContentView>
                { (dimmerState === 1) &&
                    <div className="pt-[13px]">
                        ...
                        <div className="mt-3">
                            <ReactSlider
                                className="h-[17px] w-[201px] overflow-auto bg-[url('/client-assets/images/room-widgets/dimmer/slider-spritesheet.png')] dark:bg-[url('/client-assets/images/room-widgets/dimmer/slider-spritesheet-dark.png')]"
                                ...
                                renderThumb={ (props, state) => <div { ...props }>
                                    <i className="block h-[17px] w-3 cursor-pointer bg-[url('/client-assets/images/room-widgets/dimmer/slider-spritesheet.png')] dark:bg-[url('/client-assets/images/room-widgets/dimmer/slider-spritesheet-dark.png')] bg-[-201px_0px]" />
                                </div> } />
                        </div>
                ...
                { (dimmerState === 0) &&
                    <div className="flex flex-col items-center">
                        <i className="h-[79px] w-14 bg-[url('/client-assets/images/room-widgets/dimmer/door.png')]" />
