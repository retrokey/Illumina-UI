...
export const FurnitureStickieView: FC<{}> = props =>
{
    ...
    return (
        <DraggableWindow handleSelector=".drag-handler" windowPosition={DraggableWindowPosition.TOP_LEFT}>
            <div className={"flex flex-col bg-[url('/client-assets/images/room-widgets/stickie/spritesheet.png')] w-[185px] h-[178px] px-[7px] illumina-stickie-image stickie-" + (type === "post_it" ? getStickieColorName(color) : getStickieTypeName(type)) }>
                <div className="drag-handler flex h-[19px] items-center justify-between">
                    <div className="flex h-full flex-1 items-center">
                        {canModify && (
                            <div className="flex gap-0.5">
                                <div className="ml-0.5 mr-2 h-2.5 w-[9px] cursor-pointer bg-[url('/client-assets/images/room-widgets/stickie/spritesheet.png')] bg-[-16px_-366px]" onClick={trash} />
                    ...
                    <div className="size-2.5 cursor-pointer bg-[url('/client-assets/images/room-widgets/stickie/spritesheet.png')] bg-[-2px_-366px]" onClick={onClose} />
                </div>
