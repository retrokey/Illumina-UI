    ...
    return (
        <NitroCardView uniqueKey="furniture-mannequin" className="illumina-furniture-mannequin w-[388px]">
            ...
            <NitroCardContentView>
                <div className="flex">
                    <div className="relative h-[130px] w-[83px] shrink-0 bg-[url('/client-assets/images/room-widgets/mannequin/spritesheet.png')]">
                        <LayoutAvatarImageView className="absolute !bg-[-5px_-14px]" figure={ renderedFigure } direction={ 2 } />
                        { (clubLevel > 0) && <i className="absolute bottom-3.5 right-[7px] block h-[19px] w-[15px] bg-[url('/client-assets/images/room-widgets/mannequin/spritesheet.png')] bg-[-83px_0px]" /> }
                    </div>
                        ...
                        { (mode === MODE_CONTROLLER) &&
                            <>
                                <div className="illumina-input relative mb-[11px] h-[26px] w-full">
                                    ...
                                    <i className="absolute right-[3px] top-[3px] h-[18px] w-[17px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-335px_0px] bg-no-repeat" />
                                </div>
