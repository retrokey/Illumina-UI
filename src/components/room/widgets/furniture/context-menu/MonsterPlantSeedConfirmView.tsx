    ...
    return (
        <NitroCardView uniqueKey="monsterplant-seed-confirm" className="illumina-monsterplant-seed-confirm w-[350px]">
            ...
            <NitroCardContentView center>
                <div className="flex">
                    <div className="h-[130px] w-[122px] shrink-0 bg-[url('/client-assets/images/room-widgets/furni-context/preview-bg.png')]">
                        <i className="block size-full bg-[url('/client-assets/images/room-widgets/furni-context/monsterplant-preview.png')] bg-center bg-no-repeat" />
                    </div>
