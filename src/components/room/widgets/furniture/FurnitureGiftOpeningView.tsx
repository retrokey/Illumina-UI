                ...
                { (placedItemId > -1) &&
                    <div className="flex flex-col">
                        <div className="mb-5 flex items-center gap-[15px] overflow-hidden px-2.5">
                            <div className="flex h-20 w-[81px] items-center justify-center bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-309px_-212px] bg-no-repeat">
