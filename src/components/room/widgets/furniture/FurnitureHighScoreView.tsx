        ...
        <>
            { Array.from(stuffDatas.entries()).map(([ objectId, stuffData ], index) => (
                <ObjectLocationView key={ index } objectId={ objectId } category={ RoomObjectCategory.FLOOR }>
                    <div className="relative h-[335px] w-[263px] bg-[url('/client-assets/images/highscore/spritesheet.png')] p-1">
                        ...
                        <i className="absolute -left-1.5 bottom-1.5 h-6 w-[29px] bg-[url('/client-assets/images/highscore/spritesheet.png')] bg-[-264px_0px]" />
                    </div>
                </ObjectLocationView>
            ))}
        </>
