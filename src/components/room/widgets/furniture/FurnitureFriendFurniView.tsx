            ...
            <NitroCardView uniqueKey="engraving-confirm" className="illumina-engraving-confirm w-[300px]">
                ...
                <NitroCardContentView>
                    ...
                    <div className="mb-2 flex justify-center">
                        <i className="h-[39px] w-[31px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-278px_-212px]" />
                    </div>
    ...
    if((usernames.length > 0) && (type === 0))
    {
        return (
            <DraggableWindow uniqueKey="engraving" handleSelector=".illumina-engraving">
                <div className="illumina-engraving relative w-[373px] bg-[url('/client-assets/images/room-widgets/friend-furni/spritesheet.png')]" style={ getLockView() }>
