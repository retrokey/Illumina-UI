            ...
            <div className="illumina-card orange relative max-w-[197px] p-[12px_5px_9px_7px]">
                ...
                <div className="mt-[7px] flex items-center justify-between">
                    ...
                    <Button onClick={ event => requestResponse(request.requesterUserId, true) }>
                        <i className="mr-[3px] block h-3.5 w-4 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-180px_-83px]" />
