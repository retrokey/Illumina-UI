                                ...
                                <div className="flex flex-col gap-1">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="relative h-4 w-40 border border-[#CCCCCC]">
                                            ...
                                            <div className="h-full bg-[url('/client-assets/images/infostand/pet-energy-bg.png')]" style={ { width: avatarInfo.dead ? "0" : Math.round((avatarInfo.maximumTimeToLive * 100) / (remainingTimeToLive)).toString() + "px" } } />
                                            <i className="absolute -left-2.5 -top-0.5 size-[18px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-305px_-84px]" />
                                        </div>
                                    </div>
                        ...
                        <>
                                ...
                                <div className="flex flex-col gap-1">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="relative h-4 w-40 border border-[#CCCCCC]">
                                            ...
                                            <div className="h-full bg-[url('/client-assets/images/infostand/pet-happiness-bg.png')]" style={ { width: (avatarInfo.happyness / avatarInfo.maximumHappyness) * 100 + "%" } } />
                                            <i className="absolute -left-2.5 -top-0.5 size-[18px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-324px_-84px]" />
                                        </div>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="relative h-4 w-40 border border-[#CCCCCC]">
                                            ...
                                            <div className="h-full bg-[url('/client-assets/images/infostand/pet-experience-bg.png')]" style={ { width: (avatarInfo.experience / avatarInfo.levelExperienceGoal) * 100 + "%" } } />
                                            <i className="absolute -left-2.5 -top-0.5 size-[18px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-343px_-84px]" />
                                        </div>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="relative h-4 w-40 border border-[#CCCCCC]">
                                            ...
                                            <div className="h-full bg-[url('/client-assets/images/infostand/pet-energy-bg.png')]" style={ { width: (avatarInfo.energy / avatarInfo.maximumEnergy) * 100 + "%" } } />
                                            <i className="absolute -left-2.5 -top-0.5 size-[18px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-362px_-84px]" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col items-center gap-0.5">
                                <div className="flex items-center gap-[3px]">
                                    ...
                                    <i className="h-[21px] w-[13px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-381px_-84px]" />
                                </div>
                                <p className="text-[13px]">{ LocalizeText("pet.age", [ "age" ], [ avatarInfo.age.toString() ]) }</p>
                                <p className="text-[13px]">{ LocalizeText("infostand.text.petowner", [ "name" ], [ avatarInfo.ownerName ]) }</p>
                            </div>
