                ...
                { (isJukeBox || isSongDisk) && <>
                    ...
                    <div className="mb-1.5 flex flex-col gap-[7px]">
                        ...
                        <div className="flex items-center gap-2">
                            <i className="size-3.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-303px_-38px]" />
                            <p className="text-[13px] !leading-3 [text-shadow:_0_1px_0_#fff] dark:[text-shadow:_0_1px_0_#33312B]">
                                { songName }
                            </p>
                        </div>
                        <div className="flex items-center gap-2">
                            <i className="mx-0.5 h-[11px] w-2.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-292px_-38px]" />
                            <p className="text-[13px] !leading-3 [text-shadow:_0_1px_0_#fff] dark:[text-shadow:_0_1px_0_#33312B]">
                                { songCreator }
                            </p>
                        </div>
