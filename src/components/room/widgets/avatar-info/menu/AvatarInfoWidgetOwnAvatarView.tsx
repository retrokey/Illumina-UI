                ...
                <>
                    ...
                    { (HasHabboClub() && !isRidingHorse) &&
                        <ContextMenuListItemView onClick={ event => processAction("dance_menu") }>
                            ...
                            <i className="block h-[9px] w-[5px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-214px_-100px]" />
                        </ContextMenuListItemView> }
                    ...
                    <div className="flex items-center justify-end gap-1.5">
                        <div className="illumina-btn-group">
                            <button className="illumina-btn-primary flex h-7 items-center justify-center pl-2" onClick={ event => GetUserProfile(avatarInfo.webID) }>
                                <i className="block h-3 w-4 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-436px_0px]" />
                            </button>
                            ...
                            <button className="illumina-btn-primary flex h-7 items-center justify-center pr-2" disabled>
                                <i className="block h-3.5 w-4 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-180px_-83px]" />
                            </button>
                        </div>
                    </div>
                </> }
            { (mode === MODE_CLUB_DANCES) &&
                <>
                    ...
                    <ContextMenuListItemView onClick={ event => processAction("back") }>
                        <i className="block h-[9px] w-[5px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-220px_-100px]" />
                ...
                <>
                    ...
                    { GetCanUseExpression() &&
                        <ContextMenuListItemView disabled={ !HasHabboVip() } onClick={ event => processAction("laugh") }>
                            ...
                            { !HasHabboVip() && <i className="block h-[9px] w-2.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-298px_-69px]" /> }
                        </ContextMenuListItemView> }
                    { GetCanUseExpression() &&
                ...
                <>
                    <div className="grid grid-cols-3">
                        ...
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("sign_11") }>
                            <i className="block h-[13px] w-[15px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-447px_-106px]" />
                        </ContextMenuListItemView>
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("sign_12") }>
                            <i className="block size-3 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-434px_-106px]" />
                        </ContextMenuListItemView>
                        ...
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("sign_13") }>
                            <i className="block h-[17px] w-[7px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-426px_-106px]" />
                        </ContextMenuListItemView>
                        ...
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("sign_14") }>
                            <i className="block size-5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-397px_-106px]" />
                        </ContextMenuListItemView>
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("sign_17") }>
                            <i className="block h-[19px] w-[11px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-385px_-106px]" />
                        </ContextMenuListItemView>
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("sign_16") }>
                            <i className="block h-[19px] w-[11px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-373px_-106px]" />
                        </ContextMenuListItemView>
                    </div>
                    <div className="mb-[11px] mt-0 h-0.5 w-full border-b border-white bg-[#CCCCCC] dark:border-[#36322C] dark:bg-black" />
                    <ContextMenuListItemView onClick={ event => processAction("back") }>
