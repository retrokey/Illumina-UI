                        ...
                        <div className="illumina-btn-group flex">
                            { canRequestFriend(avatarInfo.webID) && <>
                                <button className="illumina-btn-primary flex h-7 items-center justify-center pl-2">
                                    <i className="block size-4 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-197px_-100px]" onClick={ event => processAction("friend") } />
                                </button> 
                            ...
                            <button className={`illumina-btn-primary flex h-7 items-center justify-center ${!canRequestFriend(avatarInfo.webID) ? "pl-2" : ""}`}>
                                <i className="block size-3.5 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-180px_-98px]" onClick={ event => processAction("whisper") } />
                            </button>
                            <button className="illumina-btn-primary flex h-7 w-[15px] items-center justify-center" disabled>
                                <div className="h-[13px] w-0.5 border-r border-[#919191] bg-white dark:border-[#36322C] dark:bg-black" />
                            </button>
                            <button className="illumina-btn-primary flex h-7 items-center justify-center pr-2">
                                <i className="block h-4 w-[15px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-213px_-83px]" onClick={ event => processAction("report") } />
                            </button>
                        </div>
                    </div>
                </> }
                ...
                <>
                    <div className="grid grid-cols-3">
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("rship_heart") }>
                            <i className="h-3.5 w-[13px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-292px_-23px]" />
                        </ContextMenuListItemView>
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("rship_smile") }>
                            <i className="h-3.5 w-[13px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-320px_-23px]" />
                        </ContextMenuListItemView>
                        <ContextMenuListItemView className="!justify-center" onClick={ event => processAction("rship_bobba") }>
                            <i className="h-3.5 w-[13px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-306px_-23px]" />
                        </ContextMenuListItemView>
                    </div>
