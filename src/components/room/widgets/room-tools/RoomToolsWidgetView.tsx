    ...
    return (
        <div className="absolute bottom-20 left-0 z-10">
            <div className={`illumina-room-tools relative flex h-[98px] flex-col overflow-hidden py-2 pl-7 pr-2.5 text-white ${isToolsExpand ? "w-auto" : "w-[15px] !p-0"}`}>
                <div className="absolute left-0 top-0 flex h-[98px] w-[15px] cursor-pointer items-center justify-center bg-[url('/client-assets/images/room-tools/icon-bg.png')]" onClick={ () => setIsToolsExpand(!isToolsExpand) }>
                    { isToolsExpand
                        ? <i className="h-2 w-1.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-354px_-172px]" />
                        : <i className="h-2 w-1.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-361px_-172px]" /> }
                </div>
                { isToolsExpand &&
                    <>
                        ...
                        <div className="mt-6 flex gap-1.5">
                            <div className="illumina-purse flex size-7 cursor-pointer items-center justify-center" onClick={ () => handleToolClick("settings") }>
                                <i className="h-[15px] w-3.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-391px_-160px]" />
                            </div>
                            <div className="illumina-purse flex size-7 cursor-pointer items-center justify-center" onClick={ () => handleToolClick("zoom") }>
                                <i className="h-5 w-3 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-442px_-125px]" />
                            </div>
                            <div className="illumina-purse flex size-7 cursor-pointer items-center justify-center" onClick={ () => handleToolClick("chat_history") }>
                                <i className="h-[21px] w-[17px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-406px_-160px]" />
                            </div>
                            <div className={`illumina-purse flex size-7 cursor-pointer items-center justify-center ${!navigatorData.canRate ? "opacity-50" : ""}`} onClick={ () => handleToolClick("like_room") }>
                                <i className="h-[15px] w-3 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-415px_-144px]" />
                            </div>
                        </div>
                    </> }
            </div>
