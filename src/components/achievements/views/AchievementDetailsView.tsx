    ...
    return (
        <div className="flex h-[114px] pr-[7px]">
            <div className="mr-[5px]">
                <div className="flex size-[72px] items-center justify-center bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-390px_-212px]">
