            ...
            <NitroCardContentView className="h-full !overflow-auto">
                { selectedCategory && <>
                    <div className="relative flex w-full items-center justify-between">
                        <div className="flex">
                            <i className="mr-6 block h-[34px] w-[33px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-429px_-146px]" onClick={ event => setSelectedCategoryCode(null) } />
                            <div className="">
