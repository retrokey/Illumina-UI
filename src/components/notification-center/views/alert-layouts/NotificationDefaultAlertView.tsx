    ...
    return (
        <LayoutNotificationAlertView className={widthAndHeight(item.alertType)} title={ title } onClose={ onClose } { ...rest } type={ NotificationAlertType.DEFAULT }>
            <div className="flex gap-[13px] overflow-hidden">
                { hasFrank && !item.imageUrl && <i className="block h-[87px] w-8 bg-[url('/client-assets/images/notifications/frank-alert.png')] dark:bg-[url('/client-assets/images/notifications/frank-alert-dark.png')]" /> }
