        ...
        <NitroBigCardView uniqueKey="help-center" className="illumina-help-center w-[420px]" onCloseClick={ onClose }>
            ...
            <NitroBigCardContentView className="text-[#010101]">
                ...
                <div className="mb-7">
                    ...
                    <div className="flex">
                        <div className="h-[130px] w-[170px] shrink-0 bg-[url('/client-assets/images/help/bully.png')] bg-center bg-no-repeat" />
                ...
                <div className="mb-7">
                    ...
                    <div className="flex">
                        <div className="h-[130px] w-[170px] shrink-0 bg-[url('/client-assets/images/help/need-help.png')] bg-no-repeat dark:bg-[url('/client-assets/images/help/need-help-dark.png')]" />
                        <div className="ml-3.5">
