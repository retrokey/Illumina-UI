                    ...
                    <div className="illumina-toolbar-left">
                        { isInRoom
                            ? <div className="illumina-toolbar-left-item" onClick={ event => VisitDesktop() }>
                                <i className="relative block size-7 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-0px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" />
                            </div>
                            : <div className="illumina-toolbar-left-item" onClick={ event => CreateLinkEvent("navigator/goto/home") }>
                                <i className="relative block h-[30px] w-8 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-29px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" />
                            </div>
                        }
                        ...
                        <div className="illumina-toolbar-left-item" onClick={ event => CreateLinkEvent("navigator/toggle") }>
                            <i className="relative block size-8 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-91px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" />
                        </div>
                        <div className="illumina-toolbar-left-item-line" />
                        { gameCenterEnabled && <>
                            <div className="illumina-toolbar-left-item" onClick={ event => CreateLinkEvent("games/show") }>
                                <i className="relative block w-[37px] h-6 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-156px_-288px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" />
                            </div>
                            <div className="illumina-toolbar-left-item-line" />
                        </> }
                        <div className="illumina-toolbar-left-item" onClick={ event => CreateLinkEvent("catalog/toggle") }>
                            <i className="-ml-1.5 relative block size-8 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-124px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" />
                        </div>
                        <div className="illumina-toolbar-left-item-line" />
                        <div className="illumina-toolbar-left-item" onClick={ event => CreateLinkEvent("inventory/toggle") }>
                            <i className="relative block h-[29px] w-7 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-62px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]">
                        ...
                        { (isMod && modToolsClosable) && <>
                            ...
                            <div className="illumina-toolbar-left-item" onClick={ event => CreateLinkEvent("mod-tools/toggle") }>
                                <i className="relative block size-[31px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-158px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" />
                            </div>
                        </> }
                    </div>
                </div> }
            ...
            <div className="illumina-toolbar absolute bottom-0 left-0 z-10 flex h-[51px] w-full items-center justify-between">
                <div className="flex w-full items-center">
                    ...
                    { (isInRoom && cameraEnabled) && <div onClick={ event => CreateLinkEvent("camera/toggle") }>
                        <i className="relative block h-[22px] w-7 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-226px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" />
                    </div> }
                        ...
                        <>
                            <div className="flex items-center gap-3">
                                ...
                                <div onClick={ event => CreateLinkEvent("catalog/toggle") }>
                                    <i className="relative block size-8 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-124px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" />
                                </div>
                ...
                <div className="mr-[15px] flex items-center">
                    ...
                    <div className="flex items-center gap-3">
                        <i className="relative block h-[33px] w-[35px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-190px_-49px] drop-shadow-[1px_1px_0_#46423E] hover:-translate-x-px hover:-translate-y-px hover:drop-shadow-[2px_2px_0_#46423E] active:translate-x-0 active:translate-y-0 active:brightness-90 active:drop-shadow-[1px_1px_0_#46423E]" onClick={ event => CreateLinkEvent("friends/toggle") }>
