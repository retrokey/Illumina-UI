        ...
        <div ref={ elementRef } className="illumina-toolbar-me absolute bottom-[60px] left-2.5 z-20 flex items-center gap-4 px-3.5 pb-1 pt-2">
            { (GetConfiguration("guides.enabled") && useGuideTool) &&
                <div className="group flex cursor-pointer flex-col items-center" onClick={ event => DispatchUiEvent(new GuideToolEvent(GuideToolEvent.TOGGLE_GUIDE_TOOL)) }>
                    <i className="h-[29px] w-[26px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-89px_-83px] grayscale group-hover:grayscale-0" />
            ...
            <div className="group flex cursor-pointer flex-col items-center" onClick={ event => CreateLinkEvent("achievements/toggle") }>
                <div className="relative h-[30px] w-[31px]">
                    <i className="block size-full bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[0px_-83px] grayscale group-hover:grayscale-0" />
            ...
            <div className="group flex cursor-pointer flex-col items-center" onClick={ event => GetUserProfile(GetSessionDataManager().userId) }>
                <i className="h-[30px] w-8 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-147px_-83px] grayscale group-hover:grayscale-0" />
            ...
            <div className="group flex cursor-pointer flex-col items-center" onClick={ event => CreateLinkEvent("navigator/search/myworld_view") }>
                <i className="size-[30px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-116px_-83px] grayscale group-hover:grayscale-0" />
            ...
            <div className="group flex cursor-pointer flex-col items-center" onClick={ event => CreateLinkEvent("avatar-editor/toggle") }>
                <i className="h-[30px] w-[27px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-31px_-83px] grayscale group-hover:grayscale-0" />
            ...
            <div className="group flex cursor-pointer flex-col items-center" onClick={ event => CreateLinkEvent("user-settings/toggle") }>
                <i className="h-[34px] w-7 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-60px_-83px] grayscale group-hover:grayscale-0" />
