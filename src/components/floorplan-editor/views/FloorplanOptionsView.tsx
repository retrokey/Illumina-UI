                        ...
                        <div className="flex items-center gap-2.5">
                            <div className="flex items-center gap-2.5">
                                <Button className={`h-[42px] w-[51px] ${(floorAction === FloorAction.SET) ? "active" : ""}`} onClick={ event => selectAction(FloorAction.SET) }>
                                    <i className="h-4 w-[30px] bg-[url('/client-assets/images/floor-plan/spritesheet.png?')] bg-[-13px_-20px]" />
                                </Button>
                                <Button className={`h-[42px] w-[51px] ${(floorAction === FloorAction.UNSET) ? "active" : ""}`} onClick={ event => selectAction(FloorAction.UNSET) }>
                                    <i className="h-4 w-[33px] bg-[url('/client-assets/images/floor-plan/spritesheet.png?')] bg-[-44px_-20px]" />
                                </Button>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5">
                                <Button className={`h-[42px] w-[51px] ${(floorAction === FloorAction.UP) ? "active" : ""}`} onClick={ event => selectAction(FloorAction.UP) }>
                                    <i className="h-[23px] w-7 bg-[url('/client-assets/images/floor-plan/spritesheet.png?')] bg-[-78px_-20px]" />
                                </Button>
                                <Button className={`h-[42px] w-[51px] ${(floorAction === FloorAction.DOWN) ? "active" : ""}`} onClick={ event => selectAction(FloorAction.DOWN) }>
                                    <i className="h-[26px] w-7 bg-[url('/client-assets/images/floor-plan/spritesheet.png?')] bg-[-107px_-20px]" />
                                </Button>
                            </div>
                            <div className="h-[42px] w-0.5 border-r border-white bg-[#CCCCCC] dark:border-[#36322C] dark:bg-black" />
                            <Button className={`h-[42px] w-[51px] ${(floorAction === FloorAction.DOOR) ? "active" : ""}`} onClick={ event => selectAction(FloorAction.DOOR) }>
                                <i className="h-[25px] w-[34px] bg-[url('/client-assets/images/floor-plan/spritesheet.png?')] bg-[-136px_-20px]" />
                            </Button>
                        </div>
                    </div>
                    <div>
                        ...
                        <ReactSlider
                            className="h-[19px] w-[284px] bg-[url('/client-assets/images/floor-plan/spritesheet.png?')]"
                            ...
                            renderThumb={ (props, state) => <div { ...props }>
                                <i className="-ml-px mt-1.5 block h-4 w-3 bg-[url('/client-assets/images/floor-plan/spritesheet.png?')] bg-[0px_-20px]" />
                            </div> }
                        />
                    </div>
                </div>
                    ...
                    <div className="ml-9 mt-1.5 flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <ReactSlider
                                ...
                                renderThumb={ (props, state) => <div { ...props }>
                                    <i className="-ml-0.5 -mt-1.5 block h-4 w-3 bg-[url('/client-assets/images/floor-plan/spritesheet.png')] bg-[0px_-20px]" />
                                </div> }
                            />
                        </div>
                    </div>
