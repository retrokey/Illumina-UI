...
export const FriendsListGroupItemView: FC<FriendsListGroupItemViewProps> = props =>
{
            ...
            <div className="flex h-[26px] flex-1 items-center">
                ...
                <div className="flex items-center gap-1">
                    <div className="cursor-pointer" onClick={ event => GetUserProfile(searchFriend.avatarId) }>
                        <i className={`mt-px block h-3 w-4 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${selected ? "bg-[-436px_-13px]" : "bg-[-436px_0px]"}`} />
                    </div>
            ...
            <div className="flex items-center gap-2">
                { isFriend &&
                    <div className="cursor-pointer" onClick={ openMessengerChat(searchFriend.avatarId) }>
                        <i className={`block size-3.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${selected ? "bg-[-242px_-100px]" : "bg-[-180px_-98px]"}`} />
                    </div> }
                { canRequestFriend(searchFriend.avatarId) && !isFriend &&
                    <div className="cursor-pointer" onClick={ event => requestFriend(searchFriend.avatarId, searchFriend.avatarName) }>
                        <i className="block size-4 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-197px_-100px]" />
                    </div> }
            </div>
        </div>
    )
        ...
        <div className="illumina-card-item relative flex h-[26px] items-center pr-2.5">
            <div className="flex h-[26px] flex-1 items-center">
                ...
                <div className="flex items-center gap-1">
                    <div className="cursor-pointer" onClick={ event => GetUserProfile(request.id) }>
                        <i className="mt-px block h-3 w-4 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-436px_0px]" />
                    </div>
            ...
            <div className="flex items-center gap-2">
                <div className="nitro-friends-spritesheet icon-accept cursor-pointer" onClick={ event => requestResponse(request.id, true) }>
                    <i className="block h-3.5 w-4 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-180px_-83px]" />
                </div>
                <div className="nitro-friends-spritesheet icon-deny cursor-pointer" onClick={ event => requestResponse(request.id, false) }>
                    <i className="block size-[13px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-226px_-100px]" />
                </div>
            </div>
        </div>
    )
    ...
    if(friend && !isSearch) return (
        <div className={ `illumina-card-item relative flex h-[26px] cursor-pointer items-center pr-2.5 ${selected ? "dark" : ""}` } onClick={ event => selectFriend(friend.id) }>
            ...
            <div className="flex items-center gap-2">
                <i className={`h-3.5 w-[13px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${ getCurrentRelationshipName() }`} />
                <div className="cursor-pointer" onClick={ openRelationship }>
                    <i className="block h-[5px] w-[9px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-282px_-23px]" />
                </div>
                ...
                { friend.followingAllowed && <>
                    ...
                    <div className="cursor-pointer" onClick={ clickFollowFriend }>
                        <i className={`block h-2.5 w-[9px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${selected ? "bg-[-453px_-11px]" : "bg-[-453px_0px]"}`} />
                    </div>
                </> }
            </div>
            { isRelationshipOpen &&
                <div ref={ relationshipRef } className="illumina-card-item absolute right-[60px] top-5 z-10 flex flex-col items-center px-1 py-2">
                    ...
                    <div className="h-3.5 w-[13px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-292px_-23px]" onClick={ event => clickUpdateRelationship(event, MessengerFriend.RELATIONSHIP_HEART) } />
                    <div className="h-3.5 w-[13px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-320px_-23px]" onClick={ event => clickUpdateRelationship(event, MessengerFriend.RELATIONSHIP_SMILE) } />
                    <div className="h-3.5 w-[13px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-306px_-23px]" onClick={ event => clickUpdateRelationship(event, MessengerFriend.RELATIONSHIP_BOBBA) } />
                </div> }
        </div>
    )
