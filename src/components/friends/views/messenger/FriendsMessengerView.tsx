                        ...
                        { visibleThreads && (visibleThreads.length > 0) && visibleThreads.map(thread => (
                            <div key={ thread.threadId } className={`size-[35px] overflow-hidden ${activeThread === thread ? "illumina-previewer" : ""}`} onClick={ event => setActiveThreadId(thread.threadId) }>
                                <div className="relative flex !size-[35px] h-full cursor-pointer items-center justify-center overflow-hidden">
                                    { thread.unread &&
                                        <i className="absolute right-[3px] top-[7px] z-[1] h-[11px] w-[13px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-255px_-70px]" /> }
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex gap-1">
                                    <Button className="!h-5 !px-1.5" onClick={ followFriend }>
                                        <i className="block h-2.5 w-[9px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-453px_0px]" />
                                    </Button>
                                    <Button className="!h-5 !px-[7px]" onClick={ openProfile }>
                                        <i className="block h-3 w-4 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-436px_0px]" />
                                    </Button>
