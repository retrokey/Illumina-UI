            ...
            { group.chats.map((chat, index) => (
                <div key={ index } className="w-full">
                    ...
                    <div className="illumina-input mb-2 flex gap-4 py-2.5 pl-[13px] pr-1.5">
                        <i className="mt-1 block h-[21px] w-[23px] shrink-0 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[0px_-153px]" />
