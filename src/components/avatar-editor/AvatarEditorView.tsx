            ...
            <NitroCardContentView className="flex flex-1 flex-col justify-center">
                        ...
                        { categories && (categories.size > 0) && Array.from(categories.keys()).map(category => {
                            ...
                            return (
                                <Button key={ category } className={`h-[50px] w-[61px] ${isActive ? "active" : null}`} onClick={ event => selectCategory(category) }>
                                    <i className={`block bg-[url('/client-assets/images/avatar-editor/spritesheet.png')] dark:bg-[url('/client-assets/images/avatar-editor/spritesheet-dark.png')] ${isActive ? TAB_ICON_ACTIVE_STYLE[category] : TAB_ICON_STYLE[category]}`} />
                                </Button>
                            )
                        })}
                        { !genderFootballGate && <Button className={`h-[50px] w-[61px] ${isWardrobeVisible ? "active" : null}`} onClick={ event => setIsWardrobeVisible(true) }>
                            <i className={`block bg-[url('/client-assets/images/avatar-editor/spritesheet.png')] dark:bg-[url('/client-assets/images/avatar-editor/spritesheet-dark.png')] ${isWardrobeVisible ? TAB_ICON_ACTIVE_STYLE["wardrobe"] : TAB_ICON_STYLE["wardrobe"]}`} />
                        </Button> }
                    </div>
                </div>
                <div className="flex h-full flex-1 gap-1.5">
                    ...
                    <div className="mt-[42px] flex flex-1 flex-col justify-between">
                        ...
                        { showRandomFigure && <i className="block bg-[url('/client-assets/images/avatar-editor/spritesheet.png')] self-center dark:bg-[url('/client-assets/images/avatar-editor/spritesheet-dark.png')] bg-[-244px_-43px] w-[39px] h-[33px] cursor-pointer" onClick={ event => processAction(AvatarEditorAction.ACTION_RANDOMIZE) }/> }
