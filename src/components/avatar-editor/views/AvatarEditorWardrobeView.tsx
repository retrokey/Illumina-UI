        ...
        savedFigures.forEach(([ figureContainer, gender ], index) =>
        {
            ...
            items.push(
                <div className="illumina-card-item relative flex h-[122px] flex-col justify-between overflow-hidden p-1.5">
                    ...
                    { !hcDisabled && (clubLevel > 0) && <i className="absolute right-1 top-1 h-[9px] w-2.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-298px_-69px]" /> }
