    ...
    return (
        <div className="illumina-previewer relative flex h-[275px] w-full flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute bottom-4 z-10">
                <i className="block bg-[url('/client-assets/images/avatar-editor/spritesheet.png')] self-center dark:bg-[url('/client-assets/images/avatar-editor/spritesheet-dark.png')] bg-[-284px_-43px] w-[44px] h-[29px] cursor-pointer" onClick={ event => rotateFigure(figureData.direction + 1) } />
            </div>
        </div>
    )
}
