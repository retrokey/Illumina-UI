        ...
        <div className="flex items-center gap-3">
            { groups.map((group, index) => (
                <div key={ index } className="relative !size-auto cursor-pointer">
                    { itsMe && <i className={ "block size-3.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] absolute -right-0.5 -top-0.5 z-20 " + (group.favourite ? "bg-[-330px_-103px]" : "bg-[-315px_-103px]") } onClick={ () => ToggleFavoriteGroup(group) } /> }
