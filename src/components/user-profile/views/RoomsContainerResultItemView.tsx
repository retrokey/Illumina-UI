        ...
        <div className="flex h-full gap-3">
            ...
            <div className="flex max-w-40 flex-1 flex-col">
                ...
                <div className="mt-1 flex items-center gap-1">
                    <i className="h-3 w-[11px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-360px_-103px]" />
                ...
                <Button className="w-fit gap-1.5 !px-[13px]" onClick={ visitRoom }>
                    <i className="h-[17px] w-3.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-345px_-103px]" />
