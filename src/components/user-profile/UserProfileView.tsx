        ...
        <NitroBigCardView uniqueKey="profile" className="illumina-profile mt-[110px] w-[560px]" onCloseClick={ onClose }>
            ...
            <NitroBigCardContentView className="!p-0 !pt-[5px]">
                        ...
                        <div className="flex justify-end gap-1">
                            <div className="illumina-btn-group flex">
                                { getFriend(userProfile.id) && <>
                                    <button className="illumina-btn-primary flex h-7 items-center justify-center pl-2" onClick={ event => processAction("message") }>
                                        <i className="block size-3.5 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-180px_-98px]" />
                                    </button>
                                    ...
                                    <button className="illumina-btn-primary flex h-7 items-center justify-center pr-2" disabled>
                                        <i className={`block h-4 w-[15px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${ userProfile.isOnline ? "bg-[-197px_-83px]" : "bg-[-229px_-83px]" }`} />
                                    </button>
                                </> }
                            </div>
                            { !getFriend(userProfile.id) &&
                            ...
                            { canRequestFriend(userProfile.id) &&
                                <Button className="!size-7 !px-0" onClick={ event => processAction("friend") }>
                                    <i className="block size-4 cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-197px_-100px]" />
                                </Button> }
                            { !(userProfile.id === GetSessionDataManager().userId) &&
                                <Button className="!size-7 !px-0" onClick={ event => processAction("report") }>
                                    <i className="block h-4 w-[15px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-213px_-83px]" />
                                </Button> }
                        </div>
                    </div>
                ...
                <div className="flex h-[385px] pl-px">
                    <div className="h-[385px] w-[163px] shrink-0 bg-[url('/client-assets/images/profile/spritesheet.png')] bg-[0px_0px] px-2">
                        { userRelationships && 
                            <div className="mt-1">
                    ...
                    <div className="w-full px-2">
                        ...
                        <div className="absolute bottom-5 right-[21px] h-[89px] w-[123px] shrink-0 bg-[url('/client-assets/images/profile/spritesheet.png')] bg-[-164px_-297px]" />
                    </div>
                </div>
