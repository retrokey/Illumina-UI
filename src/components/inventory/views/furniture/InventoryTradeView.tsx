                    ...
                    <div className="flex w-[180px] flex-col">
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-end gap-[15px]">
                                ...
                                {ownUser.accepts
                                    ? <i className="h-11 w-9 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-38px_0px]" /> 
                                    : <i className="h-11 w-[29px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-74px_0px]" /> }
                            </div>
                            <div className="pt-3">
