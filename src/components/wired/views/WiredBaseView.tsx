    ...
    return (
        <DraggableWindow handleSelector=".illumina-wired-header">
            <div className="illumina-wired w-60 p-1.5 pb-2">
                <div className="illumina-wired-header relative flex h-[15px] w-full items-center justify-center bg-[url('/client-assets/images/wireds/header-bg.png')] bg-repeat-x">
                    <p className="font-volter_bold">{ LocalizeText("wiredfurni.title") }</p>
                    <button className="absolute right-px top-0.5" onClick={ onClose }>
                        <i className="block size-[13px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-63px_-193px] hover:bg-[-75px_-206px] active:bg-[-77px_-193px]" />
                    </button>
                </div>
                <div className="mt-[9px] px-[5px]">
                    <div className="mb-[11px]">
                        <div className="flex gap-[9px]">
                            <i className={ `block h-3.5 w-[13px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${ WIRED_TYPE[wiredType] }` } />
