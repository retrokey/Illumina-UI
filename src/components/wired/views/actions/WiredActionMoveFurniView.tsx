                        ...
                        return (
                            <div key={ index } className="flex gap-1">
                                ...
                                <label htmlFor={ `movement${ option.value }` }>
                                    <i className={ `block h-[13px] w-[26px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${ option.icon }` } />
                                </label>
                            </div>
                        )
                    })}
                        ...
                        return (
                            <div key={ option.value } className="flex gap-[9px]">
                                ...
                                <label htmlFor={ `rotation${ option.value }` }>
                                    { option.icon.length > 0 && <i className={ `inline-block h-3 w-[15px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${ option.icon }` } /> }
                                    &nbsp;
