                ...
                <div className="illumina-card mb-[18px] p-3">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="flex items-center gap-[9px]">
                            <i className={`h-[22px] w-[29px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${(userSettings.volumeSystem === 0) ? "bg-[-123px_-119px]" : "bg-[-183px_-120px]"}`} />
                            ...
                            <i className={`h-[22px] w-[29px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${(userSettings.volumeSystem === 0) ? "bg-[-213px_-120px]" : "bg-[-153px_-118px]"}`} />
                        </div>
                    </div>
                    <div className="flex items-center">
                        <p className="w-[58px] text-[13px]">{ LocalizeText("widget.memenu.settings.volume.furni") }</p>
                        <div className="flex items-center gap-[9px]">
                            <i className={`h-[22px] w-[29px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${(userSettings.volumeFurni === 0) ? "bg-[-123px_-119px]" : "bg-[-183px_-120px]"}`} />
                            ...
                            <i className={`h-[22px] w-[29px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${(userSettings.volumeFurni === 0) ? "bg-[-213px_-120px]" : "bg-[-153px_-118px]"}`} />
                        </div>
                    </div>
                    <div className="flex items-center">
                        <p className="w-[58px] text-[13px]">{ LocalizeText("widget.memenu.settings.volume.trax") }</p>
                        <div className="flex items-center gap-[9px]">
                            <i className={`h-[22px] w-[29px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${(userSettings.volumeTrax === 0) ? "bg-[-123px_-119px]" : "bg-[-183px_-120px]"}`} />
                            ...
                            <i className={`h-[22px] w-[29px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${(userSettings.volumeTrax === 0) ? "bg-[-213px_-120px]" : "bg-[-153px_-118px]"}`} />
                        </div>
                    </div>
                </div>
