...
export const GroupRoomInformationView: FC<{}> = props =>
{
    ...
    return (
        <div className={`mr-[-3px] mt-[3px] cursor-pointer bg-[url('/client-assets/images/groups/spritesheet.png')] dark:bg-[url('/client-assets/images/groups/spritesheet-dark.png')] ${isOpen ? "h-[119px] w-[195px] bg-[0px_-124px]" : "h-[25px] w-[195px] bg-[-195px_-124px]"}`}>
            <div className="flex h-[22px] items-center gap-4 px-[5px] py-[3px]" onClick={ event => setIsOpen(value => !value) }>
                <i className="h-4 w-[21px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-391px_-143px]" />
