...
export const GroupInformationView: FC<GroupInformationViewProps> = props =>
{
    ...
    const getRoleIcon = () =>
    {
        ...
        if(isRealOwner) return <i className="block h-[18px] w-[19px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-310px_-124px]" />

        if(groupInformation.isAdmin) return <i className="block h-[18px] w-[19px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-330px_-124px]" />

        return <i className="block h-[18px] w-[19px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-351px_-124px]" />
    }
                ...
                <div className="flex flex-col">
                    <div className="w-60">
                        <div className="flex items-center gap-0.5 pb-1.5">
                            <i className={ `block bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${getGroupTypeIcon[groupInformation.type]}` } />
                            { groupInformation.canMembersDecorate && <i className="block size-[15px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-294px_-125px]" /> }
