        ...
        <NitroCardView uniqueKey="group-creator" className="illumina-group-creator h-[520px] w-[392px]">
            ...
            <NitroCardContentView className="h-full">
                <div className="flex items-start pt-px">
                    { TABS.map((tab, index) => (
                        <div key={ index } className={ `flex h-7 justify-center gap-1 bg-[url('/client-assets/images/groups/spritesheet.png')] dark:bg-[url('/client-assets/images/groups/spritesheet-dark.png')] ${ getTabStyle(tab) }`}>
                ...
                <div className="mt-[13px] flex h-full flex-col">
                    <div className="flex gap-[3px]">
                        <i className={ `h-[62px] w-[114px] bg-[url('/client-assets/images/groups/spritesheet.png')] bg-no-repeat dark:bg-[url('/client-assets/images/groups/spritesheet-dark.png')] ${ TAB_HEAD_IMAGE[currentTab].position }` } />
