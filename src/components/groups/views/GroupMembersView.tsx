                    ...
                    <div className="mb-[9px] flex items-center gap-1">
                        ...
                        <div className="flex w-full flex-col gap-2">
                            ...
                            <div className="illumina-select relative flex h-[26px] items-center gap-[3px] px-2.5">
                                ...
                                <i className="pointer-events-none h-2 w-3 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-269px_-23px]" />
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="flex w-[126px] flex-col gap-0.5">
                                    <div className="flex items-center justify-between">
                                        ...
                                        { membersData.admin && (member.rank !== GroupRank.OWNER) && (member.id !== GetSessionDataManager().userId) &&
                                            <div className="cursor-pointer" onClick={ event => removeMemberOrDeclineMembership(member) }>
                                                <i className="block size-[11px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-63px_-207px]" />
                                            </div> }
                                    </div>
                                    { (member.rank !== GroupRank.REQUESTED) && membersData.admin &&
                                        <div className="group flex items-center">
                                            <div className="h-[13px] w-[18px] shrink-0">
                                                <i className={`block h-[13px] w-[11px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${ ((member.rank === GroupRank.OWNER) ? "w-[13px] bg-[-372px_-129px]" : (member.rank === GroupRank.ADMIN) ? "bg-[-386px_-129px]" : "bg-[-398px_-129px] group-hover:bg-[-386px_-129px]") }`} />
                                            </div>
                                    ...
                                    { (member.rank !== GroupRank.REQUESTED) && !membersData.admin &&
                                        <div className="flex items-center">
                                            <div className="h-[13px] w-[18px] shrink-0">
                                                <i className={`block h-[13px] w-[11px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${ ((member.rank === GroupRank.OWNER) ? "w-[13px] bg-[-372px_-129px]" : (member.rank === GroupRank.ADMIN) ? "bg-[-386px_-129px]" : "bg-[-398px_-129px]") }`} />
                                            </div>
                                            <p className="truncate text-clip text-xs italic !leading-3 text-[#757575]">{ LocalizeText("group.members.since", [ "date" ], [ member.joinedAt ]) }</p>
                                        </div> }
                    ...
                    <div className="flex items-center justify-between">
                        {(membersData.pageIndex !== 0)
                            ? <Button variant="primary" className="!w-[26px] !px-0" onClick={ event => setPageId(prevValue => (prevValue - 1)) }>
                                <i className="block h-[9px] w-2.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-56px_-118px]" />
                            </Button> 
                        ...
                        {(membersData.pageIndex !== (totalPages - 1)) && (totalPages !== 0)
                            ? <Button variant="primary" className="!w-[26px] !px-0" onClick={ event => setPageId(prevValue => (prevValue + 1)) }>
                                <i className="block h-[9px] w-2.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-56px_-128px]" />
                            </Button> 
                            : <div className="size-[26px]" /> }
                    </div>
                </div>
