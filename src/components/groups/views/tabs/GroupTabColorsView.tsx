            ...
            <div className="mr-[23px]">
                ...
                { groupData.groupColors && (groupData.groupColors.length > 0) &&
                    <div className="illumina-previewer flex gap-1 p-2">
                        <i className="h-[30px] w-9 bg-[url('/client-assets/images/groups/spritesheet.png')] dark:bg-[url('/client-assets/images/groups/spritesheet-dark.png')] bg-[-501px_-124px]" style={ { backgroundColor: "#" + getGroupColor(0) } } />
                        <i className="h-[30px] w-9 bg-[url('/client-assets/images/groups/spritesheet.png')] dark:bg-[url('/client-assets/images/groups/spritesheet-dark.png')] bg-[-501px_-124px]" style={ { backgroundColor: "#" + getGroupColor(1) } } />
                    </div> }
            </div>
                ...
                <div className="w-[135px]">
                    ...
                    <div className="grid w-full grid-cols-9">
                        { groupData.groupColors && groupCustomize.groupColorsA && groupCustomize.groupColorsA.map((item, index) => (
                            <div key={ index } className={`size-[15px] bg-[url('/client-assets/images/groups/spritesheet.png')] dark:bg-[url('/client-assets/images/groups/spritesheet-dark.png')] ${(colors[0] === item.id) ? "z-10 bg-[-407px_-124px]" : "bg-[-391px_-124px]"}`} style={ { backgroundColor: "#" + item.color } } onClick={ () => selectColor(0, item.id) }></div>
                        ))}
                    </div>
                </div>
                <div className="w-[90px]">
                    ...
                    <div className="grid w-full grid-cols-6">
                        { groupData.groupColors && groupCustomize.groupColorsB && groupCustomize.groupColorsB.map((item, index) => (
                            <div key={ index } className={`size-[15px] bg-[url('/client-assets/images/groups/spritesheet.png')] dark:bg-[url('/client-assets/images/groups/spritesheet-dark.png')] ${(colors[1] === item.id) ? "z-10 bg-[-407px_-124px]" : "bg-[-391px_-124px]"}`} style={ { backgroundColor: "#" + item.color } } onClick={ () => selectColor(1, item.id) }></div>
                        ))}
                    </div>
                </div>
            </div>
