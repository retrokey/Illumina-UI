    ...
    return (
        <div className="flex flex-col items-center">
            <div className="illumina-previewer flex min-h-[100px] w-full gap-5 px-3 pt-3.5">
                <div className="dark:g-[url('/client-assets/images/help/help-request-pending-dark.png')] h-[60px] w-[50px] shrink-0 self-end bg-[url('/client-assets/images/help/help-request-pending.png')]" />
            ...
            <Button className="w-fit gap-1.5" onClick={ cancelRequest }>
                <div className="mt-px h-3 w-[11px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-270px_-70px]" />
