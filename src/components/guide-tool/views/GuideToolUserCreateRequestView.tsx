    ...
    return (
        <>
            ...
            <div className="relative mt-3 h-[98px]">
                <div className="absolute left-0 top-[-33px] h-[120px] w-[81px] bg-[url('/client-assets/images/help/help-request.png')] dark:bg-[url('/client-assets/images/help/help-request-dark.png')]" />
