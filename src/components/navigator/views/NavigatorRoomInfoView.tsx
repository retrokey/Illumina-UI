            ...
            <NitroCardContentView>
                ...
                <div className="mb-3.5 flex gap-2">
                    { navigatorType === "r63Large" &&
                         <div className="relative flex size-[110px] shrink-0 flex-col items-center justify-end drop-shadow-[1px_1px_0_#fff] dark:drop-shadow-[1px_1px_0_#191512]">
                             <div className="absolute left-0 top-0 size-full border border-[#CCCCCC] bg-[url('/client-assets/images/profile/default-thumbnail.png')] bg-cover dark:border-[#191512]" />
                             ...
                             { hasPermission("settings") &&
                                <button className="absolute bottom-1 right-1 cursor-pointer" onClick={ () => processAction("open_room_thumbnail_camera") }>
                                    <i className="block h-[15px] w-[17px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-209px_-253px]" />
                                </button> }
                         </div> }
                    { navigatorType !== "r63Large" &&
                        <LayoutRoomThumbnailView roomId={ roomId } customUrl={ customUrl } className="rounded-md" type={ navigatorType }>
                    ...
                    <div className="flex">
                        <i className={`block h-3.5 w-[19px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] ${navigatorData.homeRoomId === navigatorData.enteredGuestRoom.roomId ? "bg-[-258px_-102px]" : "bg-[-278px_-102px]"}`} onClick={ () => processAction("set_home_room") } />
                    </div>
                </div>
                ...
                <div className="flex w-full flex-col gap-1">
                    ...
                    <Button className="mx-2.5 my-3 !h-8 gap-[9px]" onClick={ () => processAction("report_room") }>
                        <i className="block size-[19px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-227px_-252px]" />
