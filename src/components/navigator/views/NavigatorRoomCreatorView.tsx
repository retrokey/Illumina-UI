...
import { Button, ColumnProps, LayoutGridItem } from "../../../common"
                        ...
                        { roomModels.map((model, index)=> (
                            ...
                            >
                                ...
                                <div className="absolute bottom-[5px] left-[5px] flex items-center gap-[5px] bg-[#d9d9d9] p-[3px] dark:bg-[#211d19]">
                                    <i className="h-2.5 w-[18px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-302px_0px]" />
                                    <p className="font-volter text-[9px]">{ model.tileSize } { LocalizeText("navigator.createroom.tilesize") }</p>
                                </div>
                                { !hcDisabled && model.clubLevel > HabboClubLevelEnum.NO_CLUB && <i className="absolute right-1 top-1 h-[9px] w-2.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-298px_-69px]" /> }
                            </LayoutGridItem>
                        ))}
                    </div>
                </div>
