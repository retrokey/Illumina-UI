                        ...
                        <div className="relative size-80">
                            ...
                            { selectedEffectName &&
                                <div className="camera-slider absolute bottom-0 left-0 flex h-[60px] w-full flex-col items-center justify-center bg-[#00000080] ">
                                    ...
                                    <ReactSlider
                                        className="relative h-2 w-[292px] bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-1px_-539px] py-px"
                                        min={ 0 }
                                        max={ 1 }
                                        step={ 0.01 }
                                        ...
                                        renderThumb={ (props, state) => <div { ...props }>
                                            <div className="flex size-5 items-center justify-center bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-294px_-537px]" />
                                        </div> } />
                                </div> }
                        </div>
                        <div className="mt-1.5 flex gap-2">
                            <Button className="gap-1.5" onClick={ event => processAction("download") }>
                                <i className="h-[15px] w-3.5 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-410px_-126px]" />
                                <p>{ LocalizeText("postit.save") }</p>
                            </Button>
                            <Button className="gap-1.5" onClick={ event => processAction("zoom") }>
                                <i className="size-4 bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-425px_-126px]" />
