...
export const CameraWidgetEffectListItemView: FC<CameraWidgetEffectListItemViewProps> = props =>
{
    ...
    return (
        <div className="relative flex size-[62px] cursor-pointer items-center justify-center bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-405px_-474px]" onClick={ event => (!isActive && selectEffect()) }>
            ...
            { isActive &&
                <div className="absolute size-[62px]">
                    <i className="absolute right-0 top-0 z-20 size-[19px] bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-468px_-476px]" onClick={ removeEffect } />
