    ...
    return (
        <DraggableWindow uniqueKey="nitro-camera-capture">
            <div className="flex flex-col">
                ...
                <div className="drag-handler relative z-[2] h-[462px] w-[340px] bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-1px_-1px]">
                    <i className="absolute right-3 top-3 size-[11px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-63px_-207px] bg-no-repeat" onClick={ onClose } />
                    { !selectedPicture && <div ref={ elementRef } className="absolute left-2.5 top-[37px] size-80 bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-343px_-1px]" /> }
                    { selectedPicture && 
                    ...
                    <div className="flex justify-center">
                        <div className="mt-[362px] size-[94px] cursor-pointer bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-343px_-321px] hover:bg-[-535px_-321px] active:bg-[-439px_-321px]" title={ LocalizeText("camera.take.photo.button.tooltip") } onClick={ takePicture } />
                    </div>
                </div>
                { (cameraRoll.length > 0) &&
                    <div className="flex h-[73px] w-[340px] gap-[3px] bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-1px_-463px] px-3 py-[3px]">
                        { cameraRoll.map((picture, index) => (
                            <div key={ index } className="relative flex size-[62px] cursor-pointer items-center justify-center bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-405px_-474px]" onClick={ event => setSelectedPictureIndex(index) } >
                                ...
                                { selectedPictureIndex === index &&
                                    <div className="absolute size-[62px]">
                                        <i className="absolute right-0 top-0 z-20 size-[19px] bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-468px_-476px]" onClick={ onDelete } />
                                        <div className="absolute left-0 top-0 size-full rounded-lg bg-[#ffffff40]" />
                                        <div className="absolute left-0 top-0 z-10 size-full bg-[url('/client-assets/images/camera/spritesheet.png')] bg-[-342px_-474px]" />
                                    </div> }
                            </div>
                        ))}
                    </div> }
