        ...
        <div className={ getClassName } { ...rest }>
            ...
            { (itemUniqueNumber > 0)
                ? <div className={`illumina-unique-item relative z-10 flex w-full items-center justify-center ${itemUniqueSoldout && "sold-out"}`}>
                    ...
                    <div className="absolute bottom-0 z-20 mx-auto my-0 flex h-[9px] w-9 items-center justify-center bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[0px_-143px]">
