...
export const LayoutGiftTagView: FC<LayoutGiftTagViewProps> = (props) => {
    ...
    return (
        <div className="flex h-[149px] w-[306px] bg-[url('/client-assets/images/catalogue/gift-tag-bg.png')] dark:bg-[url('/client-assets/images/catalogue/gift-tag-dark-bg.png')]">
            <div className="flex h-full w-[65px] shrink-0 items-center justify-center">
                {!userName && <i className="h-12 w-[37px] bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')]" />}
