    ...
    return (
        <div className={ getClassName } { ...rest }>
            <div className="flex flex-col gap-0.5">
                <div className="flex h-[23px] w-[27px] items-center justify-center bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-83px_-118px]">
