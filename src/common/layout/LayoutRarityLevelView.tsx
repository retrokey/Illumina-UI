...
export const LayoutRarityLevelView: FC<LayoutRarityLevelViewProps> = props =>
{
    ...
    {
        const newClassNames: string[] = [ "bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-354px_-143px] w-9 h-7 flex items-center justify-center z-10" ]
