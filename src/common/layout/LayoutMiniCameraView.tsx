    ...
    return (
        <DraggableWindow handleSelector=".illumina-room-thumbnail-camera">
            <div className="illumina-room-thumbnail-camera px-2">
                <i className="absolute right-3 top-2.5 size-[11px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png')] dark:bg-[url('/client-assets/images/spritesheet-dark.png')] bg-[-63px_-207px] bg-no-repeat" onClick={ onClose } />
