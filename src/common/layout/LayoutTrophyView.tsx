...
export const LayoutTrophyView: FC<LayoutTrophyViewProps> = props =>
{
    ...
    return (
        <DraggableWindow handleSelector=".nitro-trophy">
            <div className={ `nitro-trophy flex h-[173px] w-[340px] flex-col justify-between bg-[url('/client-assets/images/room-widgets/trophy/spritesheet.png')] p-1.5 ${ getTrophyView() }` }>
