...
export const LayoutRoomThumbnailView: FC<LayoutRoomThumbnailViewProps> = props =>
{
    ...
    return (
        <div className={ getClassName } { ...rest }>
            <div className="absolute left-0 top-0 size-full bg-cover bg-center" style={{ backgroundImage: `url(${getImageUrl})` }} />
            { type === "r63" && <>
                <img src="/client-assets/images/rooms/default-thumbnail.png" />
                <div className="absolute left-0 top-0 size-full bg-[url('/client-assets/images/rooms/thumbnail-mini-bg.png')] dark:bg-[url('/client-assets/images/rooms/thumbnail-mini-dark-bg.png')]" />
            </> }
            { (type === "default" || type === "r63Large") && <>
                <img src="/client-assets/images/rooms/default-thumbnail.png" />
                <div className={`absolute left-0 top-0 size-full ${isRoom ? "bg-[url('/client-assets/images/rooms/thumbnail-bg.png')] dark:bg-[url('/client-assets/images/rooms/thumbnail-dark-bg.png')]" : "bg-[url('/client-assets/images/rooms/thumbnail-no-count-bg.png')] dark:bg-[url('/client-assets/images/rooms/thumbnail-no-count-dark-bg.png')]"}`} />
            </> }
            { children }
        </div>
    )
